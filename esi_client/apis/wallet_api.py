...
class WalletApi(object):
    ...
    def get_characters_character_id_wallets(self, character_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_characters_character_id_wallets(character_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_characters_character_id_wallets_with_http_info(character_id, **kwargs)
        else:
            (data) = self.get_characters_character_id_wallets_with_http_info(character_id, **kwargs)
            return data

    def get_characters_character_id_wallets_with_http_info(self, character_id, **kwargs):
        """
        List wallets and balances
        List your wallets and their balances. Characters typically have only one wallet, with wallet_id 1000 being the master wallet.  ---  This route is cached for up to 120 seconds
        This method makes a synchronous HTTP request by default. To make an
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_characters_character_id_wallets" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'character_id' is set
        if ('character_id' not in params) or (params['character_id'] is None):
            raise ValueError("Missing the required parameter `character_id` when calling `get_characters_character_id_wallets`")


        collection_formats = {}

        resource_path = '/v1/characters/{character_id}/wallets/'.replace('{format}', 'json')
        path_params = {}
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='list[GetCharactersCharacterIdWallets200Ok]',
